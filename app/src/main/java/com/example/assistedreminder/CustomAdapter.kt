...
class CustomAdapter(context:Context, private val list: List<Reminder>) : BaseAdapter()
{
    ...
    override fun getView(position: Int, convertView: View?, parent: ViewGroup?): View {
        ...
        row.linear.version_number.text = ""
        row.name.text = position.toLong().toString()
        row.linear.message.text = list[position].message
